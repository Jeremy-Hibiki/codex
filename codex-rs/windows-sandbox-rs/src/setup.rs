...
fn filter_sensitive_write_roots(mut roots: Vec<PathBuf>, codex_home: &Path) -> Vec<PathBuf> {
    // Never grant capability write access to GREVO_HOME or anything under GREVO_HOME/.sandbox,
    // GREVO_HOME/.sandbox-bin, or GREVO_HOME/.sandbox-secrets. These locations contain sandbox
