...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Grevo",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Grevo",
            ...
            SlashCommand::Skills => "use skills to improve how Grevo performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Grevo",
            ...
            SlashCommand::Permissions => "choose what Grevo is allowed to do",
            ...
            SlashCommand::Logout => "log out of Grevo",
