...
const FMSH_MANAGED_MARKETPLACE_NAME: &str = "fmsh";
...
pub fn is_fmsh_managed_marketplace(marketplace_name: &str) -> bool {
    marketplace_name == FMSH_MANAGED_MARKETPLACE_NAME
}
