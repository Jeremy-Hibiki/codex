#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $GREVO_HOME/skills."""
...
def _codex_home() -> str:
    return os.environ.get("GREVO_HOME") or os.environ.get("CODEX_HOME") or os.path.expanduser("~/.grevo")
